...
# ================= PATH =================
os.makedirs("/kaggle/working/lc25000", exist_ok=True)
# os.makedirs("/kaggle/working/lc25000/loss_curves", exist_ok=True)
# os.makedirs("/kaggle/working/lc25000/conf_matrices", exist_ok=True)
source = "/kaggle/working/lc25000"
...
no_opt_lr = 0.001
avg_lr = 0.000599
learning_rate_list = [no_opt_lr, 0.000537, 0.000428, 0.000871, 0.000546, 0.000613, avg_lr]
...
for run in range(NUM_RUNS):
    ...
    for learning_rate, name in zip(learning_rate_list, optimizer_names):
        ...
        model1 = Model1(2).float().to(device)
