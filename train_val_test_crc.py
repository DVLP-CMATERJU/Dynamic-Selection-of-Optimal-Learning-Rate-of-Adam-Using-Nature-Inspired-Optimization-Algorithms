...
# ================= PATH =================
os.makedirs("/kaggle/working/crc_7k", exist_ok=True)
# os.makedirs("/kaggle/working/crc_7k/loss_curves", exist_ok=True)
# os.makedirs("/kaggle/working/crc_7k/conf_matrices", exist_ok=True)
source = "/kaggle/working/crc_7k"
...
for run in range(NUM_RUNS):
    ...
    for learning_rate, name in zip(learning_rate_list, optimizer_names):
        ...
        model1 = Model1(9).float().to(device)
