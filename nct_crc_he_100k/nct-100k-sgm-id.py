# Generated from: nct-100k-sgm-id.ipynb
# Adapted from: crc-7k-sgm-id (1).ipynb — dataset switched to NCT-CRC-HE-100K
...
os.makedirs("/kaggle/working/nct_100k/loss_curves", exist_ok=True)
os.makedirs("/kaggle/working/nct_100k/conf_matrices", exist_ok=True)
...
# ================= DATA =================
data_path = "/kaggle/input/datasets/imrankhan77/nct-crc-he-100k/NCT-CRC-HE-100K"
...
checkpoint = torch.load('/kaggle/input/datasets/shreyanmajumdar/nct-100k-arabian-ckpts/best_NO_OPT_run4.pth', weights_only = True)
print(checkpoint.keys())
model.load_state_dict(checkpoint)
model.eval()
...
model = Model1(9).float().to(device)
checkpoint = torch.load('/kaggle/input/datasets/shreyanmajumdar/nct-100k-arabian-ckpts/best_GWO_run4.pth', weights_only = True)
print(checkpoint.keys())
model.load_state_dict(checkpoint)
model.eval()
...
model = Model1(9).float().to(device)
checkpoint = torch.load('/kaggle/input/datasets/shreyanmajumdar/nct-100k-arabian-ckpts/best_FIREFLY_run4.pth', weights_only = True)
print(checkpoint.keys())
model.load_state_dict(checkpoint)
model.eval()
...
model = Model1(9).float().to(device)
checkpoint = torch.load('/kaggle/input/datasets/shreyanmajumdar/nct-100k-arabian-ckpts/best_COVID_19_run4.pth', weights_only = True)
print(checkpoint.keys())
model.load_state_dict(checkpoint)
model.eval()
...
model = Model1(9).float().to(device)
checkpoint = torch.load('/kaggle/input/datasets/shreyanmajumdar/nct-100k-arabian-ckpts/best_GSA_run4.pth', weights_only = True)
print(checkpoint.keys())
model.load_state_dict(checkpoint)
model.eval()
...
model = Model1(9).float().to(device)
checkpoint = torch.load('/kaggle/input/datasets/shreyanmajumdar/nct-100k-arabian-ckpts/best_PSO_run4.pth', weights_only = True)
print(checkpoint.keys())
model.load_state_dict(checkpoint)
model.eval()
...
model = Model1(9).float().to(device)
checkpoint = torch.load('/kaggle/input/datasets/shreyanmajumdar/nct-100k-arabian-ckpts/best_AVERAGE_run4.pth', weights_only = True)
print(checkpoint.keys())
model.load_state_dict(checkpoint)
model.eval()
