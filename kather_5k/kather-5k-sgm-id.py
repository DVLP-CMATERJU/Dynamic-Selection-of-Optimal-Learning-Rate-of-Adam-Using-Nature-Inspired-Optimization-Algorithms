# Generated from: kather-5k-sgm-id.ipynb
# Converted at: 2026-06-26T11:15:57.884Z
...
model = Model1(8).float().to(device)
checkpoint = torch.load('/kaggle/input/datasets/shreyanmajumdar/kather-5k-arabian-ckpts/best_NO_OPT_run4.pth', weights_only = True)
print(checkpoint.keys())
model.load_state_dict(checkpoint)
model.eval()
...
model = Model1(8).float().to(device)
checkpoint = torch.load('/kaggle/input/datasets/shreyanmajumdar/kather-5k-arabian-ckpts/best_GWO_run4.pth', weights_only = True)
print(checkpoint.keys())
model.load_state_dict(checkpoint)
model.eval()
...
model = Model1(8).float().to(device)
checkpoint = torch.load('/kaggle/input/datasets/shreyanmajumdar/kather-5k-arabian-ckpts/best_FIREFLY_run4.pth', weights_only = True)
print(checkpoint.keys())
model.load_state_dict(checkpoint)
model.eval()
...
model = Model1(8).float().to(device)
checkpoint = torch.load('/kaggle/input/datasets/shreyanmajumdar/kather-5k-arabian-ckpts/best_COVID_19_run4.pth', weights_only = True)
print(checkpoint.keys())
model.load_state_dict(checkpoint)
model.eval()
...
model = Model1(8).float().to(device)
checkpoint = torch.load('/kaggle/input/datasets/shreyanmajumdar/kather-5k-arabian-ckpts/best_GSA_run4.pth', weights_only = True)
print(checkpoint.keys())
model.load_state_dict(checkpoint)
model.eval()
...
model = Model1(8).float().to(device)
checkpoint = torch.load('/kaggle/input/datasets/shreyanmajumdar/kather-5k-arabian-ckpts/best_PSO_run4.pth', weights_only = True)
print(checkpoint.keys())
model.load_state_dict(checkpoint)
model.eval()
...
model = Model1(8).float().to(device)
checkpoint = torch.load('/kaggle/input/datasets/shreyanmajumdar/kather-5k-arabian-ckpts/best_AVERAGE_run4.pth', weights_only = True)
print(checkpoint.keys())
model.load_state_dict(checkpoint)
model.eval()
